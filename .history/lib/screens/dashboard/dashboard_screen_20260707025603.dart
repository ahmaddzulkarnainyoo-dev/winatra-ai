              ...
              children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      Text(
                        assistant.isActive ? 'Asisten Aktif: ON' : 'Asisten Aktif: OFF',
                        style: TextStyle(
                          color: assistant.isActive ? Colors.white : appMode.textColor.withOpacity(0.4),
                          fontSize: 15,
                          fontWeight: FontWeight.bold,
                        ),
                      ),
                      ...
                      Text(
                        assistant.isActive
                            ? 'Ucapkan "Halo Winatra" untuk memulai'
                            : 'Aktifkan di Pengaturan untuk menggunakan asisten suara',
                        style: TextStyle(
                          color: assistant.isActive
